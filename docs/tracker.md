...
|---|---|---|---|---|---:|---|
| `SFV2` | required current v2 implementation program | `docs/software-factory-v2-implementation-tracker.md` | SHA-256 `0e59fbdcc570bf4616b0667393cf1584fef0a2dd820a94d07dccf7796041f20a`; Block 0 accepted at exact reviewed candidate `3901d4f6a88ed6c34f6a584c12260cfa84a36920`; Block 1 candidate `79adac40ffb5650ed46fe78f73d091109b7602e4` pending exact independent review under range `RANGE-SFV2-B0-B12-3901D4F-2079C81D` | `SFV2/B0`–`SFV2/B12` | 1 | `active` |
...
current full-range binding; Block 1 remains in progress at its pushed exact

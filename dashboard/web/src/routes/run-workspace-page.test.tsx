...
const run = {
  ...
  reports: [{ id: "CURRENT-REPORT", target_thread_id: "target-thread-1", family: "weekly", stage: "verified", status: "available", source_root: hash("5"), manifest_root: hash("6"), disposition: null, coverage: null, review_summary: null, verification: null, members: [], delivery: { status: "unavailable", configured: false, retryable: true, record_id: null, message_id: null, thread_id: null, reason: "Delivery is not configured." }, limitations: [], error: null }],
  weekly_report_workflow: {
    ...
    writer_task_id: "CURRENT-ROUNDUP-WRITER",
    expected_members: [],
    members: [],
    stages: [],
    delivery: { status: "unavailable", configured: false, retryable: true, record_id: null, message_id: null, thread_id: null, reason: "Delivery is not configured." },
  ...
  terminal_shutdown_workflow: {
    ...
    fingerprint: hash("d"),
    mission_root: currentRoot,
    state_fingerprint: "CURRENT-SHUTDOWN-STATE",
    completion_record_id: "CURRENT-TERMINAL-COMPLETION",
    lifecycle_record_id: "CURRENT-TERMINAL-LIFECYCLE",
    report_set_id: "CURRENT-TERMINAL",
    manifest_root: hash("2"),
    delivery_record_id: "CURRENT-TERMINAL-DELIVERY",
    delivery_timestamp: "2026-08-09T12:00:00Z",
    source_record: "CURRENT-TERMINAL-DELIVERY",
    gate: {
      status: "ready",
      ...
      reason: "CURRENT-SHUTDOWN-GATE",
      currentness: hash("e"),
    },
    open_heads: { incident_ids: [], decision_ids: [], successor_transition_ids: [], mission_activation_ids: [] },
    automations: [{
      role: "watcher",
      label: "CURRENT-SHUTDOWN-WATCHER",
      automation_id: "CURRENT-SHUTDOWN-AUTOMATION",
      target_thread_id: "current-role-task",
      owner_status: "ACTIVE",
    ...
    receipt: { status: "missing", record_id: null, record_sha256: null, previous_record_sha256: null, automation_state_root: null, reason: "CURRENT-SHUTDOWN-RECEIPT" },
    recovery: { posture: "ready", guidance: "CURRENT-SHUTDOWN-RECOVERY" },
    limitations: ["CURRENT-SHUTDOWN-LIMITATION"],
    error: null,
  },
  factory_evolution_workflow: {
    ...
    actionable: true,
    evolution_id: "CURRENT-EVOLUTION",
    ...
    source_report_id: "CURRENT-REPORT",
    source_report_root: hash("5"),
    event_head_sha256: hash("3"),
    manifest_root: hash("6"),
    fingerprint: hash("7"),
    proposer: { role: "base_reviewer", task_id: "CURRENT-PROPOSER" },
    implementer: { status: "awaiting-owner-proof", task_id: "target-thread-1", baseline_revision: hash("a").slice(0, 40), candidate_revision: hash("b").slice(0, 40) },
    evaluator: { role: "reviewer", task_id: "CURRENT-EVALUATOR" },
    expected_members: [],
    members: [],
    stages: [],

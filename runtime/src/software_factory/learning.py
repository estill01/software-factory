...
class LearningService:
    ...
    def create_reflection(
        ...
        *,
        ...
        self._require_mission(mission_id)
        identity = self.rsi.reflections.identify(
        ...
        with self.store.transaction() as db:
            db.execute(
                ...
                (
                    ...
                    source_type,
                    source_id,
                    identity.prompt_root,
                    _canonical(list(identity.evidence_ids)),
    ...
    def create_hypothesis(
        ...
        *,
        ...
        self._require_mission(mission_id)
        proposal = self.rsi.hypotheses.propose(
            scope_id=mission_id,
            statement=statement,
    ...
    def run_command_experiment(
        ...
        *,
        ...
        try:
            command_input = self.rsi.experiments.command_input(
        ...
        with self.store.transaction() as db:
            ...
            db.execute(
                ...
                (
                    run_id,
                    experiment_id,
                    command_input.exact_input_root,
                    _canonical(list(command_input.command)),
                    command_input.cwd,
                    started,
                ),
            )
        ...
        with self.store.transaction() as db:
            db.execute(
                ...
                (
                    ...
                    observation.stdout,
                    observation.stderr,
                    _canonical(dict(evaluation.measurement)),
            ...
            db.execute(
                ...
                (
                    "succeeded" if evaluation.passed else evaluation.disposition,
                    completed_at,
                    experiment_id,
                ),
            )

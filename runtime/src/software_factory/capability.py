...
class CapabilityService:
    ...
    def set_capability_status(
            ...
            *,
            ...
            allowed = {
                "absent": {"partial", "locally_verified"},
                ...
                "regressed": {"partial", "locally_verified", "integrated", "end_to_end_verified"},
            }
            with self.store.transaction() as db:
    ...
    def add_obligation_dependency(
            self, obligation_id: str, depends_on_id: str, condition: dict[str, Any] | None = None
        ) -> None:
    ...
    def _assert_acyclic_obligations(self, db: Any, mission_id: str) -> None:
            rows = db.execute(

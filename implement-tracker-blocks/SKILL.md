...
description: Execute eligible implementation work through the native multi-agent Software Factory v2 runtime.
---
...
```bash
sf-skill implement-tracker-blocks --mission <mission-id> --payload '<json-object>'
```

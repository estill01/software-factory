...
SOFTWARE_FACTORY_SUPERVISOR_REFRESH_HEALTH_KIND = (
...
def validate_software_factory_refresh_health_record(
    ...
    if (
        ...
        or value.get("outcome") not in {"verified", "rolled-back"}
        or re.fullmatch(
